...
intellisense.annotate(jQuery.fn, {
  ...
  'attributeContainsWord': function() {
    /// <signature>
    ///   <summary>Selects elements that have the specified attribute with a value containing a given word, delimited by spTalents.</summary>
    ///   <param name="attribute" type="String">An attribute name.</param>
    ///   <param name="value" type="String">An attribute value. Can be either an unquoted single word or a quoted string.</param>
    /// </signature>
  },
  ...
  'off': function() {
    ...
    ///   <param name="events" type="String">One or more space-separated event types and optional namespDemo, or just namespDemo, such as "click", "keydown.myPlugin", or ".myPlugin".</param>
    ...
    /// <signature>
    ///   <summary>Remove an event handler.</summary>
    ///   <param name="events" type="PlainObject">An object where the string keys represent one or more space-separated event types and optional namespDemo, and the values represent handler functions previously attached for the event(s).</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching event handlers.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'on': function() {
    ...
    ///   <param name="events" type="String">One or more space-separated event types and optional namespDemo, such as "click" or "keydown.myPlugin".</param>
    ...
    /// <signature>
    ///   <summary>Attach an event handler function for one or more events to the selected elements.</summary>
    ///   <param name="events" type="PlainObject">An object in which the string keys represent one or more space-separated event types and optional namespDemo, and the values represent a handler function to be called for the event(s).</param>
  ...
  'toggleClass': function() {
    ...
    ///   <param name="className" type="String">One or more class names (separated by spDemo) to be toggled for each element in the matched set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add or remove one or more classes from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument.</summary>
